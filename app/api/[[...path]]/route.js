    ...
    await staffCol.insertMany([
      {
        ...
        photo_url: 'https://customer-assets.emergentagent.com/job_edu-result-portal/artifacts/9g2whj4g_Founder.jpeg',
        is_founder: true,
        order: 1,
        createdAt: new Date().toISOString(),
      },
      {
        ...
        photo_url: 'https://customer-assets.emergentagent.com/job_edu-result-portal/artifacts/nn39n8ih_director%201.jpeg',
        is_founder: false,
        order: 2,
        createdAt: new Date().toISOString(),
      },
      {
        ...
        photo_url: 'https://customer-assets.emergentagent.com/job_edu-result-portal/artifacts/bxq0wjxr_director%2022.jpg',
        is_founder: false,
        order: 3,
        createdAt: new Date().toISOString(),
      },
